...
public class ProgramSet implements ProgramSetInterface {
    ...
    public ProgramSet(AbsolutePackPath directory, Function<AbsolutePackPath, String> sourceProvider, ShaderProperties shaderProperties, ShaderPack pack) {
        ...
        this.shadow = readProgramSource(directory, sourceProvider, "shadow", this, shaderProperties, BlendModeOverride.OFF);
    ...
    private ComputeSource[] readProgramArray(AbsolutePackPath directory, Function<AbsolutePackPath, String> sourceProvider, String name) {
    ...
    private void locateDirectives() {
        ...
        programs.addAll(Arrays.asList(gbuffersBasic, gbuffersBeaconBeam, gbuffersTextured, gbuffersTexturedLit, gbuffersTerrain, gbuffersTerrainSolid, gbuffersTerrainCutout,
            gbuffersDamagedBlock, gbuffersSkyBasic, gbuffersSkyTextured, gbuffersClouds, gbuffersWeather, gbuffersEntities, gbuffersEntitiesTrans, gbuffersEntitiesGlowing,
            gbuffersGlint, gbuffersEntityEyes, gbuffersBlock, gbuffersBlockTrans, gbuffersHand));
        ...
        packDirectives.getRenderTargetDirectives().getRenderTargetSettings().forEach((index, settings) -> Iris.logger.debug(
            "Render target settings for colortex" + index + ": " + settings));
    }
    ...
    public Optional<ProgramSource> get(ProgramId programId) {
        switch (programId) {
            ...
            case TerrainSolid:
                return getGbuffersTerrainSolid();
            case TerrainCutout:
            ...
            case Particles:
                return getGbuffersParticles();
            case ParticlesTrans:
                return getGbuffersParticlesTrans();
