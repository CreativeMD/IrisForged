...
public class PackShadowDirectives {
    ...
    private void acceptBufferDirectives(DirectiveHolder directives, Int2ObjectMap<SamplingSettings> settings) {
        for (int i = 0; i < PackShadowDirectives.MAX_SHADOW_COLOR_BUFFERS_IRIS; i++) {
            ...
            directives.acceptConstBooleanDirective(bufferName + "Clear", shouldClear -> settings.computeIfAbsent(finalI, sa -> new SamplingSettings()).setClear(shouldClear));
            ...
            directives.acceptConstVec4Directive(bufferName + "ClearColor", clearColor -> settings.computeIfAbsent(finalI, sa -> new SamplingSettings()).setClearColor(clearColor));
        }
    }
    
    @Override
    public String toString() {
        return "PackShadowDirectives{" + "resolution=" + resolution + ", fov=" + fov + ", distance=" + distance + ", distanceRenderMul=" + distanceRenderMul + ", entityDistanceRenderMul=" + entityShadowDistanceMul + ", intervalSize=" + intervalSize + ", depthSamplingSettings=" + depthSamplingSettings + ", colorSamplingSettings=" + colorSamplingSettings + '}';
    }
    ...
    public static class DepthSamplingSettings extends SamplingSettings {
        ...
        @Override
        public String toString() {
            return "DepthSamplingSettings{" + "mipmap=" + getMipmap() + ", nearest=" + getNearest() + ", hardwareFiltering=" + hardwareFiltering + '}';
        }
    }
}
