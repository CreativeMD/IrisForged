...
public class ImageManipulationUtil {
    ...
    private static int blendColor(int c0, int c1, int c2, int c3, float w0, float w1, float w2, float w3) {
        return FastColor.ABGR32.color(blendChannel(FastColor.ABGR32.alpha(c0), FastColor.ABGR32.alpha(c1), FastColor.ABGR32.alpha(c2), FastColor.ABGR32.alpha(c3), w0, w1, w2, w3),
            blendChannel(FastColor.ABGR32.blue(c0), FastColor.ABGR32.blue(c1), FastColor.ABGR32.blue(c2), FastColor.ABGR32.blue(c3), w0, w1, w2, w3), blendChannel(FastColor.ABGR32
                    .green(c0), FastColor.ABGR32.green(c1), FastColor.ABGR32.green(c2), FastColor.ABGR32.green(c3), w0, w1, w2, w3), blendChannel(FastColor.ABGR32.red(c0),
                        FastColor.ABGR32.red(c1), FastColor.ABGR32.red(c2), FastColor.ABGR32.red(c3), w0, w1, w2, w3));
    }
    ...
    private static int blendColor(int c0, int c1, float w0, float w1) {
        return FastColor.ABGR32.color(blendChannel(FastColor.ABGR32.alpha(c0), FastColor.ABGR32.alpha(c1), w0, w1), blendChannel(FastColor.ABGR32.blue(c0), FastColor.ABGR32.blue(
            c1), w0, w1), blendChannel(FastColor.ABGR32.green(c0), FastColor.ABGR32.green(c1), w0, w1), blendChannel(FastColor.ABGR32.red(c0), FastColor.ABGR32.red(c1), w0, w1));
    }
