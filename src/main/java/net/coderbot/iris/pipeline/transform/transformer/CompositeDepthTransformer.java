...
class CompositeDepthTransformer {
    private static final HintedMatcher<ExternalDeclaration> uniformFloatCenterDepthSmooth = new HintedMatcher<>("uniform float name;", ParseShape.EXTERNAL_DECLARATION, "centerDepthSmooth") {
        {
