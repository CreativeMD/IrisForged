...
public class AttributeTransformer {
    ...
    private static void patchTextureMatrices(ASTParser t, TranslationUnit tree, Root root, boolean hasLightmap) {
        ...
        if (hasLightmap) {
            ...
            tree.parseAndInjectNode(t, ASTInjectionPoint.BEFORE_DECLARATIONS,
                "mat4 iris_LightmapTextureMatrix =" + "mat4(iris_ONE_OVER_256, 0.0, 0.0, 0.0," + "     0.0, iris_ONE_OVER_256, 0.0, 0.0," + "     0.0, 0.0, iris_ONE_OVER_256, 0.0," + "     iris_ONE_OVER_32, iris_ONE_OVER_32, iris_ONE_OVER_32, iris_ONE_OVER_256);");
        }
        
        // column major
        tree.parseAndInjectNode(t, ASTInjectionPoint.BEFORE_DECLARATIONS,
            "mat4 iris_TextureMatrix[8] = mat4[8](" + "gl_TextureMatrix[0]," + "iris_LightmapTextureMatrix," + "mat4(1.0)," + "mat4(1.0)," + "mat4(1.0)," + "mat4(1.0)," + "mat4(1.0)," + "mat4(1.0)" + ");");
    }
    ...
    public static void patchOverlayColor(ASTParser t, TranslationUnit tree, Root root, GeometryInfoParameters parameters) {
        ...
        if (parameters.type.glShaderType == ShaderType.VERTEX) {
            ...
            tree.parseAndInjectNodes(t, ASTInjectionPoint.BEFORE_DECLARATIONS, "uniform sampler2D iris_overlay;", "out vec4 entityColor;", "out vec4 iris_vertexColor;",
                "in ivec2 iris_UV1;");
            ...
            // stage.
            tree.prependMainFunctionBody(t, "vec4 overlayColor = texelFetch(iris_overlay, iris_UV1, 0);", "entityColor = vec4(overlayColor.rgb, 1.0 - overlayColor.a);",
            ...
            tree.parseAndInjectNodes(t, ASTInjectionPoint.BEFORE_DECLARATIONS, "out vec4 entityColorGS;", "in vec4 entityColor[];", "out vec4 iris_vertexColorGS;",
    ...
    public static void patchEntityId(ASTParser t, TranslationUnit tree, Root root, VanillaParameters parameters) {
        ...
        if (parameters.type.glShaderType == ShaderType.VERTEX) {
            ...
            // TODO: this is passthrough behavior
            tree.parseAndInjectNodes(t, ASTInjectionPoint.BEFORE_DECLARATIONS, "flat out ivec3 iris_entityInfoGS;", "flat in ivec3 iris_entityInfo[];");
            tree.prependMainFunctionBody(t, "iris_entityInfoGS = iris_entityInfo[0];");
        } else if (parameters.type.glShaderType == ShaderType.FRAGMENT) {
