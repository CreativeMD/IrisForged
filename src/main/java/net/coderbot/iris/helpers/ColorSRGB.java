...
public class ColorSRGB {
     ...
     * 
     * @param c
     *            The non-linear sRGB component (0 to 255)
     ...
     * 
     * @param r
     *            The red-component in non-linear sRGB space (0.0 to 1.0)
     * @param g
     *            The green-component in non-linear sRGB space (0.0 to 1.0)
     * @param b
     *            The blue-component in non-linear sRGB space (0.0 to 1.0)
     * @param a
     *            The alpha-component in linear RGB space (0 to 255) */
     ...
     * 
     * @param c
     *            The linear RGB component (0.0 to 1.0)
