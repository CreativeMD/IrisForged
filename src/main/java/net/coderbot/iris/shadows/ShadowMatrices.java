...
public class ShadowMatrices {
    ...
    private static final class Tests {
        public static void main(String[] args) {
            ...
            // /* SHADOWHPL:32.0 */
            Matrix4f expected = new Matrix4f(0.03125f, 0f, 0f, 0f, 0f, 0.03125f, 0f, 0f, 0f, 0f, -0.007814026437699795f, 0f, 0f, 0f, -1.000390648841858f, 1f);
            
            test("ortho projection hpl=32", expected, createOrthoMatrix(32.0f));
            
            // const float shadowDistance = 110.0;
            // /* SHADOWHPL:110.0 */
            Matrix4f expected110 = new Matrix4f(0.00909090880304575f, 0, 0, 0, 0, 0.00909090880304575f, 0, 0, 0, 0, -0.007814026437699795f, 0, 0, 0, -1.000390648841858f, 1);
            ...
            Matrix4f expectedModelViewAtDawn = new Matrix4f(
                    ...
                    // column 4
                    0.38002151250839233f, 1.0264281034469604f, -100.4463119506836f, 1);
            ...
            createModelViewMatrix(modelView, 0.03451777f, 2.0f, 0.0f, 0.646045982837677f, 82.53274536132812f, -514.0264282226562f);
