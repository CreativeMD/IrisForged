...
public final class FileDialogUtil {
     ...
     *
     * @param dialog
     *            Whether to open a "save" dialog or an "open" dialog
     * @param title
     *            The title of the dialog window
     * @param origin
     *            The path that the window should start at
     * @param filterLabel
     *            A label used to describe what file extensions are allowed and their purpose
     * @param filters
     *            The file extension filters used by the dialog, each formatted as {@code "*.extension"}
