...
public class IrisElementRow {
     ...
     *            The element to add
     * @param width
     *            The width of the element in this row
     ...
     *
     * @param element
     *            The element whose width to modify
     * @param width
    ...
    public void render(GuiGraphics guiGraphics, int x, int y, int height, int mouseX, int mouseY, float tickDelta, boolean rowHovered) {
        ...
        for (Element element : this.orderedElements) {
            ...
            element.render(guiGraphics, currentX, y, currentWidth, height, mouseX, mouseY, tickDelta, rowHovered && sectionHovered(currentX, currentWidth, mouseX, mouseY));
