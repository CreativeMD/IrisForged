...
public class LinkElementWidget extends CommentedElementWidget<OptionMenuLinkElement> {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float tickDelta, boolean hovered) {
        ...
        guiGraphics.drawString(font, this.trimmedLabel, bounds.getCenterInAxis(ScreenAxis.HORIZONTAL) - (int) (labelWidth * 0.5) - (int) (0.5 * Math.max(labelWidth - (bounds
                .width() - 18), 0)), bounds.position().y() + 7, 0xFFFFFF);
