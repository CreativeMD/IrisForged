...
public final class GuiUtil {
     ...
     *
     * @param x
     *            X position of the left of the button
     * @param y
     *            Y position of the top of the button
     * @param width
     *            Width of the button, maximum 398
     * @param height
     *            Height of the button, maximum 20
     * @param hovered
     *            Whether the button is being hovered over with the mouse
     * @param disabled
    ...
    public static void drawButton(GuiGraphics guiGraphics, int x, int y, int width, int height, boolean hovered, boolean disabled) {
        ...
        guiGraphics.blit(IRIS_WIDGETS_TEX, x + halfWidth, y + halfHeight, 200 - (width - halfWidth), vOffset + (20 - (height - halfHeight)), width - halfWidth, height - halfHeight,
            256, 256);
    }
     ...
     *
     * @param font
     *            Font to use for determining the width of text
     * @param text
     *            Text to shorten
     * @param width
     *            Width to shorten text to
     ...
     *
     * @param defaultText
     *            Default text to use if no translation is found
     * @param translationDesc
     *            Translation key to try and use
     * @param format
     *            Formatting arguments for the translated text, if created
    ...
    public static class Icon {
         ...
         *
         * @param x
         *            The x position to draw the icon at (left)
         * @param y
         *            The y position to draw the icon at (top) */
