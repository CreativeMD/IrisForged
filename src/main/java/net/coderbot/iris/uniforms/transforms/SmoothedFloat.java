...
public class SmoothedFloat implements FloatSupplier {
     ...
     *
     * @param halfLifeUp
     *            the half life in the exponential decay, in deciseconds (1/10th of a second) / 2 ticks.
     *            For example, a half life of value of 2.0 is 4 ticks or 0.2 seconds
     * @param unsmoothed
     *            the input sequence of unsmoothed values to be smoothed. {@code unsmoothed.getAsFloat()} will be
     ...
     *
     * @param k
     *            the decay constant, derived from the half life
     * @param t
     *            the time that has passed since the decay started */
     ...
     * @param t
     *            the time/progress value - should be in the range of 0.0 to 1.0 */
