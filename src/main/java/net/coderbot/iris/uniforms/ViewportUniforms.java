...
public final class ViewportUniforms {
    ...
    public static void addViewportUniforms(UniformHolder uniforms) {
        ...
        uniforms.uniform1f(PER_FRAME, "viewHeight", () -> Minecraft.getInstance().getMainRenderTarget().height).uniform1f(PER_FRAME, "viewWidth", () -> Minecraft.getInstance()
                .getMainRenderTarget().width).uniform1f(PER_FRAME, "aspectRatio", ViewportUniforms::getAspectRatio);
    }
