...
public interface IrisApi {
     ...
     *
     * <p>
     * Mods that need to enable custom workarounds for shaders
     ...
     *
     * <p>
     * Generally, mods won't need to call this function for much.
     ...
     *
     * <p>
     * Pretty much the main legitimate use for this function that
     ...
     *
     * @param parent
     *            The parent screen, an instance of the appropriate
     *            {@code Screen} class.
     ...
     * 
     * @param maxQuadCount
     *            Maximum amount of quads that will be rendered with this sink
     * @param bufferProvider
     *            An IntFunction that can provide a {@code ByteBuffer} with at minimum the bytes provided by the input parameter
     * @since API 0.1 */
