...
public class MapDigraph<V> implements Digraph<V> {
     ...
     *
     * @param vertexMapFactory
     *            factory to create vertex --> edge-map maps
     * @param edgeMapFactory
     *            factory to create edge-target --> edge-value maps
     * @return map de.odysseus.ithaka.digraph factory */
    public static <V> DigraphFactory<MapDigraph<V>> getMapDigraphFactory(final VertexMapFactory<V> vertexMapFactory, final EdgeMapFactory<V> edgeMapFactory) {
     ...
     *
     * @param comparator
     *            vertex comparator (may be <code>null</code>) */
