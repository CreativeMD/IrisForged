...
public class XHFPTerrainVertex implements ChunkVertexEncoder, ContextAwareVertexWriter {
    ...
    public long write(long ptr, Material material, Vertex vertex, int chunkId) {
        ...
        MemoryUtil.memPutInt(ptr + 36, contextHolder.ignoreMidBlock ? 0 : ExtendedDataHelper.computeMidBlock(vertex.x, vertex.y, vertex.z, contextHolder.localPosX,
            contextHolder.localPosY, contextHolder.localPosZ));
