 ...
 *
 * <p>
 * It is possible for a texture coordinate to equal 1.0 or be very close to 1.0 when
 ...
 * enough to 1.0 to trigger the overflow.
 * </p>
 *
 * <p>
 * This flaw was extremely difficult to come across, because it requires a very
 ...
 *
 * <p>
 * The release of Iris 1.2.5 introduced atlas stitching optimizations by
 ...
 *
 * <p>
 * Initially, the blame was placed on the Indium mod, since the issue was only observed
 ...
 * but we were unable to find a correctness issue in the stitching code.
 * </p>
 *
 * <p>
 * Finally, after reaching out to the reporter of that issue,
 ...
 *
 * <p>
 * So, what's the end goal of all this rambling? Basically, resist the urge to place
